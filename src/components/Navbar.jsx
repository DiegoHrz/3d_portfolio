      ...
      {/* due to the fact is a react router dom so we can a link compont a onclick property */}
        <Link       
          ...
          >
            ...
            <p className='text-white text-[18px] font-bold cursor-pointer flex'>Diego &nbsp;<span className='sm:block hidden'>Hrz</span></p>
        </Link>
          ...
          {navLinks.map((Link)=>(
            <li
              ...
              className={`${
                ...
                ? 'text-white '
                : 'text-secondary'
              } hover:text-white text-[18px] font-medium hover:text-[20px] cursor-pointer`}
            >
